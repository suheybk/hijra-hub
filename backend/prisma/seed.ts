...
async function main() {
    ...
    // Create Properties using the new schema (Strings for Enums)
    const properties = [
        {
        ...
        },
        {
            ...
            description: 'Prime commercial land suitable for office tower or mixed-use development.',
            price: 8500000.0,
            location: {
                lat: 24.7523,
                lng: 46.7231,
                address: 'King Abdullah Dst, Riyadh',
                city: 'Riyadh'
            },
            type: 'LAND',
            features: {
